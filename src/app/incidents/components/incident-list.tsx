                    ...
                    <TableRow key={incident.id}>
                        ...
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <span className="cursor-help">
                              {incident.name.slice(0, 20)}
                              {incident.name.length > 20 && "..."}
                            </span>
                          </TooltipTrigger>
                          <TooltipContent>
                            <p>{incident.name}</p>
                      ...
                      <TableCell>
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <span className="cursor-help">
                              {incident.parent?.name.slice(0, 20) || "~~~~~"}
                              {incident.parent?.name &&
                                incident.parent.name.length > 20 &&
                                "..."}
                            </span>
                          </TooltipTrigger>
                          <TooltipContent>
                            <p>{incident.parent?.name || "No parent"}</p>
                          </TooltipContent>
                        </Tooltip>
                      </TableCell>
